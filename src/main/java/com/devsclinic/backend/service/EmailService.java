...
public class EmailService {
    ...
    private String buildHtmlEmail(Appointment a) {
        ...
        return "<!DOCTYPE html>" +
            ...
            "overflow:hidden;box-shadow:0 4px 24px rgba(181,68,110,0.10);'>" +

            // Header
            "<tr><td style='background:linear-gradient(135deg,#b5446e 0%,#8b2f52 100%);" +
            ...
            "<p style='margin:0 0 14px 0;font-size:11px;font-weight:700;color:#b5446e;" +
            ...
            "<div style='background:#fce8f0;border-left:4px solid #b5446e;border-radius:0 8px 8px 0;" +
            "padding:14px 18px;'>" +
            "<p style='margin:0;color:#8b2f52;font-size:14px;font-weight:600;'>" +
            "⏰ Please contact the patient within 2 hours to confirm this appointment.</p>" +
            "</div></td></tr>" +

            // System Info
            "<tr><td style='padding:20px 36px 0;'>" +
            "<p style='margin:0 0 10px 0;font-size:11px;font-weight:700;color:#b5446e;" +
            ...
            "This is an automated notification from <strong style='color:#b5446e;'>" +
    ...
    private String buildRow(String label, String value) {
        return "<tr>" +
            ...
            "vertical-align:top;border-bottom:1px solid #f0e6ec;'>" + label + "</td>" +
            "<td style='padding:10px 16px;font-size:13px;color:#1e1e1e;font-weight:500;" +
            "border-bottom:1px solid #f0e6ec;'>" + value + "</td>" +
            "</tr>";
    }
